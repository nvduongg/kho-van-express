                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="tracking_number" class="block mt-1 w-full" type="text" name="tracking_number" :value="old('tracking_number')" />
                                    <x-input-error :messages="$errors->get('tracking_number')" class="mt-2" />
                                </div>

                                <div class="mb-4">
                                    <x-input-label for="shipment_date" :value="__('Ngày Xuất hàng')" />
                                    <x-text-input id="shipment_date" class="block mt-1 w-full" type="date" name="shipment_date" :value="old('shipment_date', \Carbon\Carbon::now()->format('Y-m-d'))" required />
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="delivery_date" class="block mt-1 w-full" type="date" name="delivery_date" :value="old('delivery_date')" />
