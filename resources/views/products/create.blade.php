                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="unit" class="block mt-1 w-full" type="text" name="unit" :value="old('unit')" placeholder="Ví dụ: cái, hộp, kg" />
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="length" class="block mt-1 w-full" type="number" step="0.01" name="length" :value="old('length')" />
