                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="capacity_weight" class="block mt-1 w-full" type="number" step="0.01" name="capacity_weight" :value="old('capacity_weight')" min="0" />
                                    <x-input-error :messages="$errors->get('capacity_weight')" class="mt-2" />
                                </div>

                                <div class="mb-4">
                                    <x-input-label for="capacity_volume" :value="__('Thể tích (m³)')" />
                                    <x-text-input id="capacity_volume" class="block mt-1 w-full" type="number" step="0.01" name="capacity_volume" :value="old('capacity_volume')" min="0" />
